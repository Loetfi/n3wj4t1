    ...
    <div id="main-wrapper">
        ...
        <div class="panel panel-primary">
            <div class="panel-body">
                <form action="<?php echo site_url('order/prosespod?projectname='.@urlencode($_POST['projectname']).'&tipeorder='.@$_POST['tipeorder'].'&deadline='.@$_POST['deadline']) ?>" method="POST">
                    <!-- tipe order -->
                    <input type="hidden" name="tipeorder" value="pod">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <a href="<?php echo site_url('order/pod?reset=y') ?>" onclick="return confirm('Cancel Order dapat mereset order page ini');" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($this->cart->contents() as $items){ ?> 
                            <tr>
                                ...
                                <td>Nama Proyek</td>
                                <td width="1%">:</td>
                                <td><?php echo $items['options']['0']['projectname']; ?></td>
                                <td rowspan="10">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <?php echo $items['options']['0']['orderdate']; ?> 
                                </td>
                            </tr>
                            <tr>
                                <td>Qty</td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <?php //echo implode(',', $items['options']['0']['finishing']);
        ...
        <?php $disabled = ""; $link = site_url('order/previewpod?projectname='.@$_GET['projectname'].'&tipeorder='.@$_GET['tipeorder'].'&deadline='.@$_GET['deadline']); if (count($this->cart->contents()) == 0 ) { $disabled = 'disabled=""'; $link = "#"; } ?>
