    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="content">
                ...
                <legend>FORM PEMBAYARAN PELUNASAN</legend>
                <form action="<?php echo site_url('pelunasan/create') ?>" method="POST" target="_blank">
...
<script>
    ...
    $('#thisNominalPembayaran').val(sisa);
